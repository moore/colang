...
impl Table<Value,VmError> for TableTypes {
...
impl Cursor<Value,VmError> for CursorTypes {
...
impl Cursor<Value,VmError> for FnCursor {
    type Table = FnTable;
    fn found(&self) -> bool {
        todo!()
    }
...
impl Table<Value,VmError> for FnTable {
